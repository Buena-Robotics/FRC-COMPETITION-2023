...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        pose = odometry.update(getRotation(), GamePositionUtils.getInstance().encoderToMeters(leftBackMotor.getEncoder().getPosition()), GamePositionUtils.getInstance().encoderToMeters(rightBackMotor.getEncoder().getPosition()));
    }
